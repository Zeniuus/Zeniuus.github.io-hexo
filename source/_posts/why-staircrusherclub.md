...
2. 더 큰 회사로 간다.
    1. 큰 회사의 트래픽 및 시스템이나
    2. 외국계 회사를 경험해보고 싶었다.
3. 사이드 프로젝트로 참여하다가 창업을 하게 된 팀, 계단뿌셔클럽에 합류한다.
<br>
...
내가 선택한 건 계단뿌셔클럽 팀(이하 계뿌클)에 합류하는 것이었다.
...
2022년과 2025년의 마음간에 차이점이 하나 있다면, 그것은 마음의 크기이다. 돈이 되지 않는 일을 하고 싶다는 갈증은 3년이 지나면서 사그라들기는 커녕 조금씩, 조금씩 더 커졌다.
...
이런 의미에서, 인생의 일부를 계뿌클 팀에 있는 사람들과 함께 몰입하고, 공유하고 싶었다. VCNC와 라포랩스에서 그리 했던 것처럼 말이다. 다정하면서도 뾰족함을 추구하는 사람들, 더 살기 좋은 사회를 만드는 데 기꺼이 참여하는 사람들, 긍정적인 에너지를 뿜어내며 주변을 즐겁게 만드는 사람들. 내 인생에서 이들과 접한 면적을 늘리고, 함께 밀도 있는 시간을 보내며 그들을 닮아가면 좋겠다고 생각했다.
